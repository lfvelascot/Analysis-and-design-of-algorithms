...
win.title("Cliente Supermercado N° "+idt)
win.geometry("500x500")
ip = "192.168.0.14"
port = 5000
cliente_id = "Cliente "+idt
icon = "icons/market.png" # ubicacíón del icono 
estadoVar = ""
flag = False
...
labeltext= tkinter.Label(win, text="DESCUENTO 15%", font=('Helvetica', 18, 'bold')).grid(padx=5,pady=5,row=0, column=0, columnspan=2)
...
Salario = tkinter.Label(win, text="Valor compra: $").grid(padx=5,pady=5,row=2, column=0, sticky="ew")
